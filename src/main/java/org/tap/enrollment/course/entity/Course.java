package org.tap.enrollment.course.entity;
...
public class Course {
	...
	@Column (name = "courseCode") 					// This annotation specify the mapping between the fields of the class and the columns of the database table
